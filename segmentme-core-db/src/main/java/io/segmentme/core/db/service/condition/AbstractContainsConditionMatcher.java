...
public abstract class AbstractContainsConditionMatcher extends AbstractConditionMatcher<ArrayCondition> {
    ...
    @Override
    public boolean match(ArrayCondition condition, AnalysisContext context) {
    ...
    private Collection<Comparable<Object>> getCollection(String propertyName, AnalysisContext context) {
