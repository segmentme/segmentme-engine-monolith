...
public class StatisticWorm implements BiConsumer<AbstractCondition, Object> {
    private Map<Integer, ConditionStatisticEntry> statisticMap = new HashMap<>();

    @Override
    public void accept(AbstractCondition condition, Object result) {

        var statisticEntry = statisticMap.computeIfAbsent(condition.hashCode(), key -> new ConditionStatisticEntry());
